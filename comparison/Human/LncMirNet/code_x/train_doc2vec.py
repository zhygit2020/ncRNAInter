...
# mirna_dict = read_fa("./data/mature.fa")
...
lncrna_dict = read_fa("./data/gencode.v38.lncRNA_transcripts.fa")
# lncrna_dict = read_fa("./data/gencode.v33.lncRNA_transcripts.fasta")
