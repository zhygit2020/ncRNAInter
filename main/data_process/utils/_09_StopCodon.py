...
def get_stop_codon_num(infasta):
    ...
    for seq in SeqO.parse(infasta,'fasta'):
        ...
        stop_codon_num = _stop_codon_num(seq.seq.replace('U','T'))
...
def get_stop_codon_frequency(infasta):
    ...
    for seq in SeqO.parse(infasta,'fasta'):
        seqid = seq.id
        seqname.append(seqid)
        stop_codon_frequency = _stop_codon_frequency(seq.seq.replace('U','T'))
...
def get_stop_frequency_frame_score(infasta):
    ...
    for seq in SeqO.parse(infasta,'fasta'):
        seqid = seq.id
        seqname.append(seqid)
        stop_codon_frequency = _stop_frequency_frame_score(seq.seq.replace('U','T'))
        stop_codon_frequency_all.append(stop_codon_frequency)
...
def get_stop_num_frame_score(infasta):
    ...
    for seq in SeqO.parse(infasta,'fasta'):
        seqid = seq.id
        seqname.append(seqid)
        stop_codon_frequency = _stop_num_frame_score(seq.seq.replace('U','T'))
        stop_codon_frequency_all.append(stop_codon_frequency)
...
def get_stop(infasta):
    ...
    for seq in SeqO.parse(infasta,'fasta'):
        ...
        stop_codon_numfram = _stop_num_frame_score(seq.seq.replace('U','T'))
        stop_codon_numfram_all.append(stop_codon_numfram)
        stop_codon_frequencyfram = _stop_frequency_frame_score(seq.seq.replace('U','T'))
