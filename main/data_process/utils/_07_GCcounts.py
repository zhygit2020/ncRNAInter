...
class GCconder():
    ...
    def get_GC1(self):
        ...
        for seq in SeqO.parse(self.infasta,'fasta'):
            seqid = seq.id
            seqname.append(seqid)
            GC1_ = self.GC1(seq.seq.replace('U','T'))
            GC1_all.append(GC1_)
    ...
    def get_GC2(self):
        ...
        for seq in SeqO.parse(self.infasta,'fasta'):
            seqid = seq.id
            seqname.append(seqid)
            GC2_ = self.GC2(seq.seq.replace('U','T'))
            GC2_all.append(GC2_)
    ...
    def get_GC3(self):
        ...
        for seq in SeqO.parse(self.infasta,'fasta'):
            seqid = seq.id
            seqname.append(seqid)
            GC3_ = self.GC3(seq.seq.replace('U','T'))
            GC3_all.append(GC3_)
    ...
    def get_gc1_frame_score(self):
        ...
        for seq in SeqO.parse(self.infasta,'fasta'):
            seqid = seq.id
            seqname.append(seqid)
            gc1_frame_score_ = self.gc1_frame_score(seq.seq.replace('U','T'))
    ...
    def get_gc2_frame_score(self):
        ...
        for seq in SeqO.parse(self.infasta,'fasta'):
            seqid = seq.id
            seqname.append(seqid)
            gc2_frame_score_ = self.gc2_frame_score(seq.seq.replace('U','T'))
    ...
    def get_gc3_frame_score(self):
        ...
        for seq in SeqO.parse(self.infasta,'fasta'):
            seqid = seq.id
            seqname.append(seqid)
            gc3_frame_score_ = self.gc3_frame_score(seq.seq.replace('U','T'))
